...
public class StaticInitBoard implements InitBoardBehaviour {
	final Board board;
	Random rand = new Random();
	public StaticInitBoard(Board board){
		this.board = board;
	}
	public void initBoard(final JFrame frame) {
        ...
        board.feedBirdButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	board.starveBirdspressed = false;
